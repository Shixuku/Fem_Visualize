...
namespace {
	...
	// Catch mouse events.
	class PointPickerCellInteractor : public vtkInteractorStyleTrackballCamera
	{
	public:
		static PointPickerCellInteractor* New();

		PointPickerCellInteractor()
		{
	...
	vtkStandardNewMacro(PointPickerCellInteractor);
